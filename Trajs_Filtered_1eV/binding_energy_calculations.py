...
def binding_energy(adsorb, n_NH3, n_H, metal):
    traj_file = 'filtered_traj_1eV_' + adsorb + '.traj' 
    ...
    save_y_fname = 'y_1eV_' + adsorb + '.npy' 
...
np.save('y_all_adsorb_1eV.npy', a)


np.load('y_all_adsorb_1eV.npy').shape
